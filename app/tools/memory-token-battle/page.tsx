  ...
  return (
    <main id="main-content">
      ...
      <section className={styles.pageSection}><div className="site-container">
        ...
        <nav className={styles.related} aria-label="관련 페이지"><div><p className="eyebrow">KEEP PLAYING</p><h2>MAKEON의 다른 퍼즐도 즐겨보세요.</h2></div><div><Link className="button button-secondary" href="/tools">무료 도구 전체 보기</Link><Link className="button button-primary" href="/tools/pastel-memory-match">메모리 카드 맞추기</Link></div></nav>
      </div></section>
    </main>
  );
}
