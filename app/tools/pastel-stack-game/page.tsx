...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "최고 높이, 점수, 콤보와 소리·진동 설정은 현재 브라우저의 localStorage에만 저장됩니다. 서버나 데이터베이스로 전송하지 않습니다.",
  },
  {
    question: "소리가 자동으로 재생되지 않는 이유는 무엇인가요?",
    answer:
      "브라우저의 자동재생 정책과 사용자의 선택을 존중해 기본값은 음소거입니다. 소리 켬 버튼을 누른 뒤 게임을 조작하면 부드러운 합성 효과음이 재생됩니다.",
  },
  {
        ...
        <div className="site-container">
          <div className={styles.intro}>
            ...
            <p>
              ...
              맞춰 퍼펙트 콤보를 이어가고 브라우저에 저장되는 최고 기록을 갱신해보세요.
            </p>
          </div>
